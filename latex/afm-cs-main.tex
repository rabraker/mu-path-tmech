...
% Except that it passed through this region for all of the sub-line scans, which did not scan exactly the same area...
...
CS appears to preserve the edges of the holes better than sub-line sampling,
while sub-line sampling has less noise in the flat areas of the specimen. 

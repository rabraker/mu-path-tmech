...
\todo{When written this way, it seems that BP+VV/TV can could also be interpreted in the frameowrk of overcomplete dictionaries?\cite{candes_redundant_2011}. }
...
%   W = \begin{bmatrix}U^T\\\alpha_hD_h\\\alpha_vD_v \end{bmatrix}.
\end{equation*}
...
\begin{table}\label{tab:cs_tasks}
  \centering
...
\todo{Dramatically truncate this section}
...
\todo{Not clear to me that friction is useful if I scan parallel to cantilever. Also not clear to me that the normal force and shear force are orthogonal concepts. Maybe the macroscopic analogy breaks down, but thinking of a knife pushed into a surface and then dragged...}
...
\begin{figure}
  \includesvg[width=1\columnwidth]{figures/cs_raster_images_4-26-2019}
...
\begin{figure*}[t!]
  \includesvg[width=1\textwidth]{figures/cs_raster_pixel_rows_3-20-2019.svg}
...
\begin{figure*}[h!]
  ...
  %   \includesvg[scale=1]{figures/cs_rast_time_vs_ssim_psnr.svg}
  ...
  % \begin{subfigure}{1\textwidth}
    \includesvg[scale=1]{figures/cs_rast_damage.svg}

...
\todo{ add stuff about nPoint stage and C300.}
...
\begin{figure*}[ht!]
  \centering \includesvg[scale=0.85]{figures/cs_cycle.svg}
  \caption{Several CS cycles. Each state is indicated by color.}
  \label{fig:mupathsignaltrajectory}
\end{figure*}
\todo{Make fig \ref{fig:mupathsignaltrajectory}  smaller}
...
%     \includesvg[width=1\textwidth]{figures/justify_small_lift.svg}
%     \caption{ }
%     % \label{fig: }
%   \end{subfigure}
%   \begin{subfigure}{.48\textwidth}
%     \includesvg[width=01\textwidth]{figures/justify_small_lift_zoom.svg}
%     \caption{ }
%     % \label{fig: }
%   \end{subfigure}
...
\begin{figure*}
  \includesvg[scale=1]{figures/cs_raster_images_4-26-2019}
...
% \begin{figure*}
%   \includesvg[scale=1]{figures/cs_raster_images_err_4-26-2019}

...
images the first and second images are \baseline{one2twoNoAlgnPsnr} and
...
\baseline{one2twoAlgnSsim} for both sets of images and
while the PSNR is increases to \baseline{one2twoAlgnPsnr} and \baseline{one2sixAlgnPsnr}
respectively.

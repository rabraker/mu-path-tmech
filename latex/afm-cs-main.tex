...
scans: the top is a 512 by 512 pixel image of a CS20NG grating (Ted Pella, USA) acquired
...
CS20NG (on a typical laptop computer).
...
We took scans of a Ted Pella CS20NG sample grating over an area with

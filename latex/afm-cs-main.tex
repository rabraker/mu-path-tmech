...
\begin{abstract}
  ...
  $\mu$-path scanning achieves better image quality than subline sampling.
  Conversely, for faster scan rates, subline sampling achieves better image quality
  in less time, though at a penalty in the damage index.

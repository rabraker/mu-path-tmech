...
Moreover, when written as \eqref{op:bp_tvW}, the problem is in a form that may be solved with to NESTA~\cite{becker_nesta_2011}. For completeness, we give an overview here.

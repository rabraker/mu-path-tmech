...
The control structure for each axis is similar and essentially consists of a set of filters in series with a PI controller. The open-loop frequency response for the $Z$-axis is shown in Fig.~\ref{fig:z_control} (red curve) and in Fig.~\ref{fig:mimo_frf_uxuy} for the $X$ and $Y$ axes (black curves). The first resonance of each axis is the bending mode. For the $Z$ axis, this resonance is at 215~Hz and at approximately 350~Hz for the $X$ and $Y$ axes.
...
\begin{figure*}
  \includesvg[width=1\linewidth]{figures/cs_raster_images_6-5-2019.svg}
  \caption{Raster and compressed sensing images of a 5 micron square area of the
